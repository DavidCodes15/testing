    ...
    <>
        ...
        <div className="carousel-container mt-5" ref={carouselRef}>
          ...
          >
            {certs.map((cert, index) => (
              <div
                key={index}
                className="carousel-item relative flex flex-col justify-center items-center space-y-2"
              >
                <img
                  className="w-[288px] h-[367px]"
                  src={cert.imageUrl}
                  alt={cert.imageAlt}
                />
                <button
      ...
      <section className="container mx-auto flex justify-center items-center px-4">
        {texts.map((text, index) => (
          <p
            key={index}
            className="max-w-[1000px] flex justify-center items-center text-left"
          >
