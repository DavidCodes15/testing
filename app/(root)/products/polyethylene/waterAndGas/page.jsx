        ...
        <div className="flex flex-col lg:flex-row justify-center items-center space-x-0 px-4 lg:items-start lg:space-x-32">
          ...
          <div className="flex flex-col space-y-4 justify-center items-center pr-2 lg:items-start lg:pr-0">
            <div className="hidden lg:flex max-w-[616px] flex-col justify-center items-start space-y-6">
              ...
              <p>
               {selectedLanguage === "GEO" && `2017 წლიდან ჩვენ ვაწარმოებთ წყლისა და გაზმომარაგების პოლიეთილენის მილებს
დიამეტრით 20 მმ-დან 630 მმ-მდე. წნევის დიაპაზონი PN6-დან PN25-მდე. ჩვენი PE100
მილები წყალმომარაგებისთვის სრულად აკმაყოფილებს EN 12201-2:2011 და ISO 4427-
1:2019 სტანდარტებს. გაზმომარაგებისთვის განკუთვნილი PE100 მილები კი შეესაბამება
ISO 17484-1:2012 და EN 155-2:2021 სტანდარტებს.`}
               {selectedLanguage === "ENG" && `Since 2017 we are producing polyethylene pipes for water and gas supply ranging from 20 mm to 630
mm in diameter and with pressure ranges from PN6 to PN25. PE pipes for water supply meet the
standards EN 12201-2:2011, ISO 4427-1:2019 ensuring their safety and performance. PE pipes intended
for gas supply adhere to the standards ISO 17484-1:2012 and EN 155-2:2021.`}
               {selectedLanguage === "RUS" && `С 2017 года мы производим полиэтиленовые трубы для водоснабжения и газоснабжения
диаметром от 20 мм до 630 мм. Диапазон давления от PN6 до PN25. Наши трубы PE100 для
водоснабжения полностью соответствуют стандартам EN 12201-2:2011 и ISO 4427-1:2019. Трубы
ПЭ100, предназначенные для газоснабжения, соответствуют стандартам ISO 17484-1:2012 и EN
155-2:2021.`}
              </p>
            </div>
