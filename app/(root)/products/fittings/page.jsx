...
const fittingsPage = () => {
  ...
  const translatedCategories = {
    ...
    "პოლიპროპილენის მილებისთვის" : "პოლიპროპილენის მილებისთვის",
    ...
    ENG: {
      ...
      "პოლიპროპილენის მილებისთვის" : "For polypropylene pipes",
    ...
    RUS: {
      ...
      "პოლიპროპილენის მილებისთვის" : "Для полипропиленовых труб",
          ...
          <div className="hidden lg:flex justify-center items-center space-x-6">
            {Ids.map((id, index) => (
              <button
                ...
                } px-4 py-2 rounded-2xl border-[#1A3DA7] border-[1px] border-solid text-[14.5px]`}
              >
